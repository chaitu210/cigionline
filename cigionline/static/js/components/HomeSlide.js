...
const HomeSlide = ({ year, language }) => {
  return (
    <div id="ember13" class="liquid-container ember-view" style={{}}>
      <div
        id="ember15"
        class="liquid-child ember-view"
        style={{ top: 0, left: 0 }}
      >
        <div class="background-row show-for-medium">
          ...
          <div class="cigi-social">
            ...
            >
              <svg
                ...
                data-prefix="fab"
                id="ember17"
                class="svg-inline--fa fa-facebook-square fa-w-14 fa-lg ember-view"
              >
                <path
                  fill="currentColor"
            ...
            <a
              class="social-2-btn"
              href="https://twitter.com/intent/tweet?status=2020+CIGI+Annual+Report+https://www.cigionline.org/interactives/2020annualreport/en/"
              target="_blank"
            ...
            >
              <svg
                ...
                data-prefix="fab"
                id="ember18"
                class="svg-inline--fa fa-twitter fa-w-16 fa-lg ember-view"
              >
                <path
                  fill="currentColor"
            ...
            <a
              class="social-3-btn"
              href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https://www.cigionline.org/interactives/2020annualreport/en/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
                ...
                data-prefix="fab"
                id="ember19"
                class="svg-inline--fa fa-linkedin-in fa-w-14 fa-lg ember-view"
              >
                <path
                  fill="currentColor"
            ...
            <button
              class="open-social-menu-btn"
              type="button"
              data-ember-action=""
              data-ember-action-20="20"
            >
              <svg
                viewBox="0 0 448 512"
                xmlns="http://www.w3.org/2000/svg"
                ...
                data-prefix="fal"
                id="ember21"
                class="svg-inline--fa fa-share-alt fa-w-14 fa-lg ember-view"
              >
                <path
                  fill="currentColor"
