    ...
    if (linkType == "PUBLICATION") {
      ...
      return (
        <svg
          ...
          data-icon="film"
          data-prefix="fal"
          class="svg-inline--fa fa-film fa-w-16 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-prefix="fal"
          class="svg-inline--fa fa-comment-alt-lines fa-w-16 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-icon="newspaper"
          data-prefix="fal"
          class="svg-inline--fa fa-newspaper fa-w-18 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-icon="volume-up"
          data-prefix="fal"
          class="svg-inline--fa fa-volume-up fa-w-18 fa-lg"
        >
          <path
            fill="currentColor"
