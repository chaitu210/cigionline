...
const ContentSlide = ({ slide }) => {
  ...
  function contentLinkIcon(linkType) {
    ...
    if(linkType=='PUBLICATION'){
      return (<svg viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="file-alt" data-prefix="fal" id="ember3428" className="svg-inline--fa fa-file-alt fa-w-12 fa-lg ember-view">
      ...
      return (<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="film" data-prefix="fal" id="ember1205" class="svg-inline--fa fa-film fa-w-16 fa-lg ember-view">
      ...
      return (<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="comment-alt-lines" data-prefix="fal" id="ember1263" class="svg-inline--fa fa-comment-alt-lines fa-w-16 fa-lg ember-view"><path fill="currentColor" d="M448 0H64C28.7 0 0 28.7 0 64v288c0 35.3 28.7 64 64 64h96v84c0 7.1 5.8 12 12 12 2.4 0 4.9-.7 7.1-2.4L304 416h144c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64zm32 352c0 17.6-14.4 32-32 32H293.3l-8.5 6.4L192 460v-76H64c-17.6 0-32-14.4-32-32V64c0-17.6 14.4-32 32-32h384c17.6 0 32 14.4 32 32v288zM280 240H136c-4.4 0-8 3.6-8 8v16c0 4.4 3.6 8 8 8h144c4.4 0 8-3.6 8-8v-16c0-4.4-3.6-8-8-8zm96-96H136c-4.4 0-8 3.6-8 8v16c0 4.4 3.6 8 8 8h240c4.4 0 8-3.6 8-8v-16c0-4.4-3.6-8-8-8z"></path>
</svg>
                        )
    }else if(linkType=='MEDIA'){
      return (<svg viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="newspaper" data-prefix="fal" id="ember1323" class="svg-inline--fa fa-newspaper fa-w-18 fa-lg ember-view"><path fill="currentColor" d="M552 64H88c-13.234 0-24 10.767-24 24v8H24c-13.255 0-24 10.745-24 24v280c0 26.51 21.49 48 48 48h504c13.233 0 24-10.767 24-24V88c0-13.233-10.767-24-24-24zM32 400V128h32v272c0 8.822-7.178 16-16 16s-16-7.178-16-16zm512 16H93.258A47.897 47.897 0 0 0 96 400V96h448v320zm-404-96h168c6.627 0 12-5.373 12-12V140c0-6.627-5.373-12-12-12H140c-6.627 0-12 5.373-12 12v168c0 6.627 5.373 12 12 12zm20-160h128v128H160V160zm-32 212v-8c0-6.627 5.373-12 12-12h168c6.627 0 12 5.373 12 12v8c0 6.627-5.373 12-12 12H140c-6.627 0-12-5.373-12-12zm224 0v-8c0-6.627 5.373-12 12-12h136c6.627 0 12 5.373 12 12v8c0 6.627-5.373 12-12 12H364c-6.627 0-12-5.373-12-12zm0-64v-8c0-6.627 5.373-12 12-12h136c6.627 0 12 5.373 12 12v8c0 6.627-5.373 12-12 12H364c-6.627 0-12-5.373-12-12zm0-128v-8c0-6.627 5.373-12 12-12h136c6.627 0 12 5.373 12 12v8c0 6.627-5.373 12-12 12H364c-6.627 0-12-5.373-12-12zm0 64v-8c0-6.627 5.373-12 12-12h136c6.627 0 12 5.373 12 12v8c0 6.627-5.373 12-12 12H364c-6.627 0-12-5.373-12-12z"></path>
</svg>
                        )
    }else if(linkType=='PODCAST'){
      return (<svg viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="volume-up" data-prefix="fal" id="ember1619" class="svg-inline--fa fa-volume-up fa-w-18 fa-lg ember-view"><path fill="currentColor" d="M342.91 193.57c-7.81-3.8-17.5-.48-21.34 7.5-3.81 7.97-.44 17.53 7.53 21.34C343.22 229.2 352 242.06 352 256s-8.78 26.8-22.9 33.58c-7.97 3.81-11.34 13.38-7.53 21.34 3.86 8.05 13.54 11.29 21.34 7.5C368.25 306.28 384 282.36 384 256s-15.75-50.29-41.09-62.43zM231.81 64c-5.91 0-11.92 2.18-16.78 7.05L126.06 160H24c-13.26 0-24 10.74-24 24v144c0 13.25 10.74 24 24 24h102.06l88.97 88.95c4.87 4.87 10.88 7.05 16.78 7.05 12.33 0 24.19-9.52 24.19-24.02V88.02C256 73.51 244.13 64 231.81 64zM224 404.67L139.31 320H32V192h107.31L224 107.33v297.34zM421.51 1.83c-7.89-4.08-17.53-1.12-21.66 6.7-4.13 7.81-1.13 17.5 6.7 21.61 84.76 44.55 137.4 131.1 137.4 225.85s-52.64 181.3-137.4 225.85c-7.82 4.11-10.83 13.8-6.7 21.61 4.1 7.75 13.68 10.84 21.66 6.7C516.78 460.06 576 362.67 576 255.99c0-106.67-59.22-204.06-154.49-254.16zM480 255.99c0-66.12-34.02-126.62-88.81-157.87-7.69-4.38-17.59-1.78-22.04 5.89-4.45 7.66-1.77 17.44 5.96 21.86 44.77 25.55 72.61 75.4 72.61 130.12s-27.84 104.58-72.61 130.12c-7.72 4.42-10.4 14.2-5.96 21.86 4.3 7.38 14.06 10.44 22.04 5.89C445.98 382.62 480 322.12 480 255.99z"></path>
</svg>
                        )
    }
}
  ...
  return slide.value.links.map(function(link){
    return (<a className="clearfix content-link show-for-large" href={link.value.url} target="_blank" rel="noopener noreferrer">
                      ...
                      <div className="content-copy">
                        ...
                        <p>
                          <span className="underline" dangerouslySetInnerHTML={{ __html: link.value.title }}>
                          </span>
                        </p>
                      </div>
                    </a>)
      ...
      <div id="ember1402" >
        <div id="ember1271" >
          <div className="background-row show-for-medium" style={{}}>
            <div className="background-image" style={{   backgroundImage: slide.value.background_image ? `url(${originUrl}${slide.value.background_image.original})` : ''}}>
            <div className="hover-reveal hover-reveal-gradient-right"  style={{opacity: contentOpacity ? 0 : 1}}>
              <div className="quote quote-right" style={{opacity: contentOpacity ? 0 : 1}}>
                ...
                <div className="hover-reveal-quote-line" style={{width: contentOpacity ? 0 : 100}}></div>
              </div>
            </div>
          </div>
          <div id="ember3426" className="ember-view">
          {slide.value.background_video ? 
            <video playsinline="" autoplay="" muted="" loop="" id="background-video" className="video-background">
              <source src={`${originUrl}${slide.value.background_video.original}`} type="video/mp4" />
            </video> : ''}
          </div>
          <div className="background-overlay hover-reveal-hide"></div>
          <div className="background-gradient-overlay hover-reveal-hide"></div>
        </div>
        <div className="content-slide hover-reveal-hide" style={{opacity: contentOpacity ? 1 : 0}}>
              ...
              <div className="grid-x grid-margin-x">
                ...
                <div className="cell large-6 paragraphs">
                  ...
                  <div className="content-links-mobile hide-for-large">
                    <a className="clearfix content-link-mobile" href="https://www.cigionline.org/sites/default/files/documents/Strategic_Plan-2020-web-2_1.pdf" target="_blank" rel="noopener noreferrer">
                    Read CIGI’s new Strategic Plan focused on shaping governance in a digital era.
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div className="footer clearfix show-for-large">
          <button className="footer-icon-btn" type="button" data-ember-action="" data-ember-action-3429="3429" onMouseOver={changeStyle} onMouseOut={changeStyle} style={{opacity: 1}}>
            ...
            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="camera-retro" data-prefix="fal" id="ember3430" className="svg-inline--fa fa-camera-retro fa-w-16 fa-lg ember-view">
