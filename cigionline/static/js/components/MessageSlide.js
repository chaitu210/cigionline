...
const MessageSlide = ({ slide }) => {
  ...
  return firstHalf.map(function(paragraph, index){
    return paragraph.value}).join('');
}

function secondHalfBody() {
  const half = Math.ceil(slide.value.body.length / 2);  
  const secondHalf = slide.value.body.slice(-half)
  return secondHalf.map(function(paragraph, index){
    return paragraph.value}).join('');
}
        ...
        <div id="ember13" className="liquid-container ember-view" style={{}}>
          ...
          <div id="ember1402" classNameName="ember-view">
            <div id="ember1271" className="liquid-child ember-view" style={{top: 0, left: 0, opacity: 1}}>
              <div className="background-row chairs-message-background show-for-medium" style={{}}></div>
              ...
              <div className="chairs-message"  style={{opacity: contentOpacity ? 1 : 0}}>
                <div className="grid-container">
                  ...
                  <div className="grid-x grid-margin-x">
                    <div className="cell medium-6 hover-reveal-hide" dangerouslySetInnerHTML={{ __html: firstHalfBody() }}>
                    </div>
                    <div className="cell medium-6 hover-reveal-hide" dangerouslySetInnerHTML={{ __html: secondHalfBody() }}>
                    </div>
                    ...
                    <div className="cell medium-6 hover-reveal-hide">
                      ...
                      <p className="chair-name">
                        ...
                        <br/><em>{ slide.value.author.position }</em>
                      </p>
                    </div>
                  </div>
                </div>
