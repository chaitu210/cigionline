      ...
      <div className="App">
        <div className="liquid-container" style={{}}>
          ...
          >
            <div>
              <div
                class="background-row financials-background show-for-medium"
                style={{}}
              ></div>
                    ...
                    <div class="cell financials-container">
                      <div class="grid-x grid-margin-x">
                        <div class="cell">
                          <div class="financials-menu">
                            ...
                            <a
                              href="/interactives/2020annualreport/en/financials/summarized-statement-of-financial-position"
                            ...
                            <span class="menu-break">/</span>
                            <a
                              href="/interactives/2020annualreport/en/financials/summarized-statement-of-revenues-and-expenses-and-changes-in-fund-balances"
                            ...
                            <div class="download-button">
                              ...
                              >
                                <svg
                                  ...
                                  data-icon="download"
                                  data-prefix="fal"
                                  class="svg-inline--fa fa-download fa-w-16 fa-lg"
                                >
                                  <path
                                    fill="currentColor"
                      ...
                      >
                        <div
                          ...
                          style={{ top: 0, left: 0 }}
                        >
                          <div class="grid-x grid-margin-x financials-content">
                            <div class="cell medium-6">
                              ...
                              <h4>Opinion</h4>
                              <p>
                                The summary financial statements, which comprise
                                the summary statement of financial position as
                                at July 31, 2020, the summary statement of
                                revenues and expenses and changes in fund
                                balances for the year then ended, are derived
                                from the audited financial statements of The
                                Centre for International Governance Innovation
                                (the “Organization”) as at and for the year
                                ended July 31, 2020.
                              </p>
                              <p>
                                In our opinion, the accompanying summary
                                financial statements are a fair summary of the
                                audited financial statements in accordance with
                                the basis developed by management, which
                                includes removing the statement of cash flows,
                                retaining major subtotals, totals and
                                comparative information, and retaining the
                                information from the audited financial
                                statements dealing with matters having a
                                pervasive or otherwise significant effect on the
                                summary financial statements.
                              </p>
                              <h4>Summary Financial Statements</h4>
                              <p>
                                The summary financial statements do not contain
                                all the disclosures required by Canadian
                                accounting standards for not-for-profit
                                organizations. Reading the summary financial
                            ...
                            <div class="cell medium-6">
                              <Fragment>
                                ...
                                <p>
                                  ...
                                  of the summary financial statements on a basis
                                  developed by management, which includes
                                  removing the statement of cash flows,
                                  retaining major subtotals, totals and
                                  comparative information, and retaining the
                                  information from the audited financial
                                  statements dealing with matters having a
                                  pervasive or otherwise significant effect on
                                  the summary financial statements.
                                </p>
                                <h4>Auditor’s Responsibility</h4>
                                <p>
                                  Our responsibility is to express an opinion on
                                  whether the summary financial statements are a
                                  fair summary of the audited financial
                                  statements based on our procedures, which were
                                  conducted in accordance with Canadian Auditing
                                  Standard (CAS) 810, Engagements to Report on
                                  Summary Financial Statements.
                                </p>
                                <h4>Other matter</h4>
                                <p>
                                  The audited financial statements of the
                                  Organization are available upon request by
