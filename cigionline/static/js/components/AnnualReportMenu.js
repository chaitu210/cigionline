...
const AnnualReportMenu = ({ toggleMenu, isOpen, otherLangSlug, language, slides }) => {
  ...
  return (
    <MenuPortal>
      <div className="cigi-top-bar" style={{opacity: 1}}>
        <div className="cigi-logo">
          <a href="https://www.cigionline.org">
            <svg className="show-for-large" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129.4 37.8">
            ...
            <svg className="hide-for-large" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 45.9 25.6" enable-background="new 0 0 45.9 25.6" xmlSpace="preserve">
        ...
        <div className="cigi-menu">
            { language == 'en' ?
            (<><span className="intl-selected">
              EN
            </span>
          <span>/</span>
              <a href="#" className="ember-view intl-link" onClick={setLanguage}>
                FR
              </a></>) :
              (<><a href="#" className="ember-view intl-link"  onClick={setLanguage}>
                EN
            ...
            <button className={`${isOpen ? 'close-' : 'open-'}menu-btn`} type="button" onClick={toggleMenu}>
            { isOpen ? (<svg viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="times" data-prefix="fal" id="ember1250" class="svg-inline--fa fa-times fa-w-10 fa-lg ember-view"><path fill="currentColor" d="M193.94 256L296.5 153.44l21.15-21.15c3.12-3.12 3.12-8.19 0-11.31l-22.63-22.63c-3.12-3.12-8.19-3.12-11.31 0L160 222.06 36.29 98.34c-3.12-3.12-8.19-3.12-11.31 0L2.34 120.97c-3.12 3.12-3.12 8.19 0 11.31L126.06 256 2.34 379.71c-3.12 3.12-3.12 8.19 0 11.31l22.63 22.63c3.12 3.12 8.19 3.12 11.31 0L160 289.94 262.56 392.5l21.15 21.15c3.12 3.12 8.19 3.12 11.31 0l22.63-22.63c3.12-3.12 3.12-8.19 0-11.31L193.94 256z"></path>
</svg>) :
              (<svg viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" role="img" focusable="false" aria-hidden="true" data-icon="bars" data-prefix="fal" id="ember1048" className="svg-inline--fa fa-bars fa-w-14 fa-lg ember-view"><path fill="currentColor" d="M442 114H6a6 6 0 0 1-6-6V84a6 6 0 0 1 6-6h436a6 6 0 0 1 6 6v24a6 6 0 0 1-6 6zm0 160H6a6 6 0 0 1-6-6v-24a6 6 0 0 1 6-6h436a6 6 0 0 1 6 6v24a6 6 0 0 1-6 6zm0 160H6a6 6 0 0 1-6-6v-24a6 6 0 0 1 6-6h436a6 6 0 0 1 6 6v24a6 6 0 0 1-6 6z"></path>
              </svg>)
            }
            </button>
        </div>
